    ...
    <SafeAreaView className="flex-1 bg-brand-dark" edges={['top']}>
      ...
      <ScrollView className="flex-1 px-4" contentContainerClassName="pb-8">
        ...
        <AppCard className="mb-6">
          <Text className="text-base text-brand-text leading-relaxed">{provider.description}</Text>
          <View className="flex-row items-center mt-4 pt-4 border-t border-brand-border">
            ...
            <Text className="text-brand-muted ml-2 text-sm">Hausbesuche - wir kommen zu dir</Text>
          </View>
        </AppCard>
